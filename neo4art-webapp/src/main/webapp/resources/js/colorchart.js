...
function load(p) {
	...
	var serviceUrl = "http://localhost:8080/neo4art-services/api/services/timeline/search.json?searchInput="
			+ p.query.toString().replace(/\+/g, " ");
	$.ajax({
		method : 'get',
		url : "http://localhost:8080/neo4art-services/api/services/timeline/search.json?searchInput="
				+ p.query.toString().replace(/\+/g, " "),
		dataType : 'json',
