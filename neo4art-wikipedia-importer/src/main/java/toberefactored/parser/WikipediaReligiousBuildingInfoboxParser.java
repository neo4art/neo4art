...
import toberefactored.parser.util.InfoboxArchitecturalParser;
import toberefactored.parser.util.InfoboxCaptionParser;
import toberefactored.parser.util.InfoboxCoordinateParser;
import toberefactored.parser.util.InfoboxLeadershipParserUtil;
import toberefactored.parser.util.InfoboxMap;
import toberefactored.parser.util.InfoboxNameParser;
import toberefactored.parser.util.InfoboxParserUtil;
import toberefactored.parser.util.InfoboxPlaceParser;
import toberefactored.parser.util.InfoboxUnitsMeasurementParser;
