...
public class WikipediaInfoboxParser
{
   ...
   * @return
   */
  public static boolean isColour(String text)
  {
    return StringUtils.contains(text, "{{Infobox color");
  }
   ...
   * @return
   */
  public static boolean isDocument(String text)
  {
    return StringUtils.contains(text, "{{Infobox document");
  }
   ...
   * @return
   */
  public static boolean isBook(String text)
  {
    return StringUtils.contains(text, "{{Infobox book");
  }
