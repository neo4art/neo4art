 ...
 * @since 30 Apr 2015
 */
public class WikipediaReligiousBuildingMonasteryInfobox
{
  ...
  public static ReligiousBuilding parse(String text)
  {
    ...
    for (String key : map.keySet())
    {
      ...
      {
        case NAME:
          monastery.setName(InfoboxParserUtil.removeAllParenthesis(map.get(key)));
          break;
        case IMAGE:
      ...
      monastery.setCoordinates(coordinates);
    }
