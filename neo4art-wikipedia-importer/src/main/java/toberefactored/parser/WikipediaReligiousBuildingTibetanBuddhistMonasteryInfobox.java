...
public class WikipediaReligiousBuildingTibetanBuddhistMonasteryInfobox
{
  ...
  public static ReligiousBuilding parse(String text)
  {
    ...
    for (String key : map.keySet())
    {
      ...
      {
        case NAME:
          tibetanBuddhistMonastery.setBuildingName(InfoboxParserUtil.removeAllParenthesis(map.get(key)));
          break;
        case STYLE:
          tibetanBuddhistMonastery.setType(map.get(key));
          break;
        case IMAGE:
          tibetanBuddhistMonastery.setImage(InfoboxUrlParser.infoboxUrl(map.get(key)));
          break;
        case LATD:
      ...
      tibetanBuddhistMonastery.setCoordinates(coordinates);
    }
