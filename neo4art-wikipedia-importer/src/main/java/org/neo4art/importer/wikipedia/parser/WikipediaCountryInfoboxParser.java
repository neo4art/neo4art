    ...
    for (String key : map.keySet()) {
      ...
      switch (key) {
        ...
        case COMMON_NAME:             
          ...
          break;
        case LATD:                    
          country.setLatD(map.get(key));                    
          break;
        case LATM:                    
          country.setLatM(map.get(key));                    
          break;
        case LATNS:                   
          country.setLatNS(map.get(key));                   
          break;
        case LONGD:                   
          country.setLongD(map.get(key));                   
          break;
        case LONGM:                   
          country.setLongM(map.get(key));                   
          break;
        case LONGEW:                  
          country.setLongEW(map.get(key));                  
          break;
      }
    }
