...
public class WikipediaSettlementInfoboxParser {
  ...
  //public static final String PUSHPIN_LABEL_POSITION          = "pushpin_label_position";
  ...
  //public static final String PUSHPIN_LABEL_POSITION1         = "pushpin_label_position1";
  ...
  //public static final String COORDINATES_FOOTNOTES           = "coordinates_footnotes";
  ...
  //public static final String ELEVATION_MAX_FOOTNOTES         = "elevation_max_footnotes";
  ...
  //public static final String ELEVATION_MIN_FOOTNOTES         = "elevation_min_footnotes";
  ...
  //public static final String POPULATION_URBAN_FOOTNOTES      = "population_urban_footnotes";
  //public static final String POPULATION_URBAN                = "population_urban";
  //public static final String POPULATION_DENSITY_URBAN_KM2    = "population_density_urban_km2";
  //public static final String POPULATION_DENSITY_URBAN_SQ_MI  = "population_density_urban_sq_mi";
  //public static final String POPULATION_RURAL_FOOTNOTES      = "population_rural_footnotes";
  //public static final String POPULATION_RURAL                = "population_rural";
  //public static final String POPULATION_DENSITY_RURAL_KM2    = "population_density_rural_km2";
  //public static final String POPULATION_DENSITY_RURAL_SQ_MI  = "population_density_rural_sq_mi";
  //public static final String POPULATION_METRO_FOOTNOTES      = "population_metro_footnotes";
  //public static final String POPULATION_METRO                = "population_metro";
  //public static final String POPULATION_DENSITY_METRO_KM2    = "population_density_metro_km2";
  //public static final String POPULATION_DENSITY_METRO_SQ_MI  = "population_density_metro_sq_mi";
  ...
  //public static final String POPULATION_BLANK1_TITLE         = "population_blank1_title";
  //public static final String POPULATION_BLANK1               = "population_blank1";
  //public static final String POPULATION_DENSITY_BLANK1_KM2   = "population_density_blank1_km2";
  //public static final String POPULATION_DENSITY_BLANK1_SQ_MI = "population_density_blank1_sq_mi";
  //public static final String POPULATION_BLANK2_TITLE         = "population_blank2_title";
  //public static final String POPULATION_BLANK2               = "population_blank2";
  //public static final String POPULATION_DENSITY_BLANK2_KM2   = "population_density_blank2_km2";
  //public static final String POPULATION_DENSITY_BLANK2_SQ_MI = "population_density_blank2_sq_mi";
  ...
  //public static final String DEMOGRAPHICS1_FOOTNOTES         = "demographics1_footnotes";
  ...
  //public static final String DEMOGRAPHICS2_FOOTNOTES         = "demographics2_footnotes";
  ...
  public static Settlement parse(String text) {
    ...
    for (String key : map.keySet()) {
      ...
      switch (key) {
        ...
        case NAME            :
          settlement.setName(map.get(key));
          break;
        case OFFICIAL_NAME   :
          settlement.setOfficialName(map.get(key));
          break;
        case NATIVE_NAME     :
          settlement.setNativeName(map.get(key));
          break;
        case NATIVE_NAME_LANG:
          settlement.setNativeNameLang(map.get(key));
          break;
        case OTHER_NAME      :
          settlement.setOtherName(map.get(key));
          break;
        case SETTLEMENT_TYPE :
          settlement.setSettlementType(map.get(key));
          break;
        case LATD            :
          settlement.setLatD(map.get(key));
          break;
        case LATM            :
          settlement.setLatM(map.get(key));
          break;
        case LATS            :
          settlement.setLatS(map.get(key));
          break;
        case LATNS           :
          settlement.setLatNS(map.get(key));
          break;
        case LONGD           :
          settlement.setLongD(map.get(key));
          break;
        case LONGM           :
          settlement.setLongM(map.get(key));
          break;
        case LONGS           :
          settlement.setLongS(map.get(key));
          break;
        case LONGEW          :
          settlement.setLongEW(map.get(key));
          break;
        case WEBSITE         :
          settlement.setWebsite(map.get(key));
          break;
      }
    }
