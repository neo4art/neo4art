 ...
 * @since 25.02.2015
 */
public class WikipediaRelationshipsImporterListener extends WikipediaAbstractImporterListener implements WikipediaImporterListener {

  private static Log logger = LogFactory.getLog(WikipediaRelationshipsImporterListener.class);
  ...
  public void flush() {
    ...
    try (Transaction tx = graphDatabaseService.beginTx()) {
      ...
      for (WikipediaElement wikipediaElement : this.wikipediaElementBuffer) {
        ...
        newRelatioships += wikipediaElementManager.createRelationships(graphDatabaseService, wikipediaElement);
