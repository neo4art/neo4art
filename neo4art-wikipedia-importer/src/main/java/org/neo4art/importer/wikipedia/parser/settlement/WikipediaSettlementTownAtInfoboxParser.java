...
public class WikipediaSettlementTownAtInfoboxParser {
	...
	public static final String LATHEM = "lat_hem";
	...
	public static final String LONGHEM = "lon_hem";
	...
	public WikipediaSettlementTownAtInfoboxParser() {
	}
