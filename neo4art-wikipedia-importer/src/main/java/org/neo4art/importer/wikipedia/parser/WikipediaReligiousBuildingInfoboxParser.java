  ...
  public static ReligiousBuilding parse(String text) {
    ...
    for (String key : map.keySet()) {
      ...
      switch (key) {
        ...
        case BUILDING_NAME         :
          religiousBuilding.setBuildingName(map.get(key));
          break;
        case NATIVE_NAME           :
        ...
        case NATIVE_NAME_LANG      :
          ...
          break;
        case IMAGE                 :
          religiousBuilding.setImage(map.get(key));
          break;
        case IMAGE_SIZE            :
        ...
        case ALT                   :
          ...
          break;
        case CAPTION               :
          religiousBuilding.setCaption(map.get(key));
          break;
        case MAP_TYPE              :
        ...
        case MAP_CAPTION           :
          ...
          break;
        case LOCATION              :
          religiousBuilding.setLocation(map.get(key));
          break;
        case COORDINATES           :
          religiousBuilding.setCoordinates(map.get(key));
          break;
        case LATITUDE              :
        ...
        case RELIGIOUS_AFFILIATION :
          religiousBuilding.setReligiousAffiliation(map.get(key));
          break;
        case RITE                  :
          religiousBuilding.setRite(map.get(key));
          break;
        case REGION                :
        ...
        case STATE                 :
          ...
          break;
        case PROVINCE              :
          religiousBuilding.setProvince(map.get(key));
          break;
        case TERRITORY             :
        ...
        case HERITAGE_DESIGNATION  :
          ...
          break;
        case LEADERSHIP            :
          religiousBuilding.setLeadership(map.get(key));
          break;
        case PATRON                :
          religiousBuilding.setPatron(map.get(key));
          break;
        case WEBSITE               :
          religiousBuilding.setWebsite(map.get(key));
          break;
        case ARCHITECTURE          :
          religiousBuilding.setArchitecture(map.get(key));
          break;
        case ARCHITECT             :
          religiousBuilding.setArchitect(map.get(key));
          break;
        case ARCHITECTURE_TYPE     :
          religiousBuilding.setArchitectureType(map.get(key));
          break;
        case ARCHITECTURE_STYLE    :
          religiousBuilding.setArchitectureStyle(map.get(key));
          break;
        case GENERAL_CONTRACTOR    :
          religiousBuilding.setGeneralContractor(map.get(key));
          break;
        case FACADE_DIRECTION      :
          religiousBuilding.setFacadeDirection(map.get(key));
          break;
        case GROUNDBREAKING        :
          religiousBuilding.setGroundbreaking(map.get(key));
          break;
        case YEAR_COMPLETED        :
          religiousBuilding.setYearCompleted(map.get(key));
          break;
        ...
        case SPECIFICATIONS        :
          ...
          break;
        case CAPACITY              :
          religiousBuilding.setCapacity(map.get(key));
          break;
        case LENGTH                :
          religiousBuilding.setLength(map.get(key));
          break;
        case WIDTH                 :
          religiousBuilding.setWidth(map.get(key));
          break;
        case WIDTH_NAVE            :
          religiousBuilding.setWidthNave(map.get(key));
          break;
        case HEIGHT_MAX            :
          religiousBuilding.setHeightMax(map.get(key));
          break;
        case DOME_QUANTITY         :
          religiousBuilding.setDomeQuantity(map.get(key));
          break;
        case DOME_HEIGHT_OUTER     :
          religiousBuilding.setDomeHeightOuter(map.get(key));
          break;
        ...
        case MINARET_HEIGHT        :
          ...
          break;
        case SPIRE_QUANTITY        :
          religiousBuilding.setSpireQuantity(map.get(key));
          break;
        case SPIRE_HEIGHT          :
          religiousBuilding.setSpireHeight(map.get(key));
          break;
        case MATERIALS             :
          religiousBuilding.setMaterials(map.get(key));
          break;
        case NRHP                  :
