...
/**
 * Service for storing other kinds of Wikipedia Pages into neo4j.
 * 
 * @author Lorenzo Speranzoni
 * @since 25.02.2015
 */
public class WikipediaGenericManager extends WikipediaAbstractElementManager implements WikipediaElementManager {
    ...
    return wikipediaRepository.addGeneric((WikipediaGeneric) wikipediaElement);
	}
}
