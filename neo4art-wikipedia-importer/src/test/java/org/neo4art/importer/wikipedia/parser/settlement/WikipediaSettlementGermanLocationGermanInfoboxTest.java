...
import org.neo4art.importer.wikipedia.parser.settlement.WikipediaSettlementGermanLocationInfoboxParser;
...
public class WikipediaSettlementGermanLocationGermanInfoboxTest {
	...
	public void shoudParseSettlement() throws MalformedURLException{
		...
		Assert.assertEquals("German location", settlement.getType());
	}
