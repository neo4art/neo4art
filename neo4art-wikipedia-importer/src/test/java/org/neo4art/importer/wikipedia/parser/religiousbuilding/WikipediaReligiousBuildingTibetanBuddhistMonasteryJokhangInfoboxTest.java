...
import org.neo4art.importer.wikipedia.parser.religiousBuilding.WikipediaReligiousBuildingTibetanBuddhistMonasteryInfobox;

public class WikipediaReligiousBuildingTibetanBuddhistMonasteryJokhangInfoboxTest {

	private static String INFOBOX = "{{Infobox Tibetan Buddhist monastery\n"+
			"|name = Jokhang\n"+
	...
	public void shouldParseMuseumInfobox() throws MalformedURLException {
		...
		Assert.assertEquals("Tibetan Buddhist monastery" , tibetanBuddhistMonastery.getType());
