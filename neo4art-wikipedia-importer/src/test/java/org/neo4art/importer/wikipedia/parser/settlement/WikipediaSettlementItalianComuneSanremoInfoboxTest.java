...
import org.neo4art.importer.wikipedia.parser.settlement.WikipediaSettlementItalianComuneInfoboxParser;
...
public class WikipediaSettlementItalianComuneSanremoInfoboxTest {
	...
	public void shoudParseSettlement() throws MalformedURLException{
		...
		Assert.assertEquals("Italian comune", settlement.getType());
	}
